...
class _CheckOutState extends State<CheckOut> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      },buttomText: "PAY \$1329 ->",width: 1,color: Colors.green,fontSize: 25,textColor: Colors.white,)) ,
                   ...
                   Container(
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text("Phone",style: firstFontCard,),
                          SizedBox(height: 10.0,),
                          Container(
                            padding: EdgeInsets.all(10.0),
                            decoration: BoxDecoration(
                          ...
                          DefultTextFiled(controller: controller,lable: "Phone Number",),
                          SizedBox(height: 10.0,),
                          DefultButtom(buttomText: "ADD NEW Phone",
                            ontap: (){
